...
particle = (function() {
    ...
    function createBoxes() {
        ...
        for(var i=0; i < numberOfBoxes; i++){
            ...
            arrayOfBoxesTwo[i] = new THREE.Mesh( geometry, material );
            scene.add( arrayOfBoxesTwo[i] );
            arrayOfBoxesTwo[i].position.set(0,0,0);
        }
    ...
    function animate() {
        ...
        for(var i=0; i < arrayOfBoxes.length; i++){
            arrayOfBoxes[i].rotation.y += 0.02;
            arrayOfBoxes[i].rotation.x = Math.cos(i * 3);
            arrayOfBoxes[i].rotation.z = Math.sin(i * 2);


            arrayOfBoxesTwo[i].rotation.x = Math.cos(i * 3);
            arrayOfBoxesTwo[i].rotation.z = Math.sin(i * 2);
            ...
            arrayOfBoxesTwo[i].position.x = (Math.sin(time + i) * circleRadius / 2);
            arrayOfBoxesTwo[i].position.z = (Math.cos(time + i) * circleRadius / 2);
